...
public class ContactUS {
	...
	private void initialize() {
		...
		frame.getContentPane().add(headerLine);
		...
		frame.getContentPane().add(ContactUSBigLabel);
		...
		frame.getContentPane().add(TellUsLabel);
		...
		frame.getContentPane().add(CotactUsLabel);
