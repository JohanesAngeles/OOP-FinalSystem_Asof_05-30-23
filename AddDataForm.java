...
public class AddDataForm {
    ...
    private void initialize() {
        ...
        logo = new JLabel("");
        logo.setIcon(new ImageIcon(AddDataForm.class.getResource("/images/Smallerlogo.png")));
        logo.setBounds(162, 38, 134, 50);
        ...
        inputNewDataLabel.setBounds(103, 128, 263, 50);
        frame.getContentPane().add(inputNewDataLabel);
